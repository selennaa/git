...
public class Medianum {
	...
	public static void main(String[] args) {
		/*
		 * pide números por pantalla y los almacena en un array hasta que se introduzca un número negativo
		 * que no será tenido en cuenta o hasta que esté lleno el array. 
