...
public class BotonesMensajesMenuBarra extends JFrame implements ActionListener {
	...
	public BotonesMensajesMenuBarra() {
		...
		tbAdios.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/abrir.gif")));
		toolBar.add(tbAdios);
		
		tdKaixo = new JButton("Kaixo");
		tdKaixo.addActionListener(this);
		tdKaixo.setToolTipText("Kaixo");
		tdKaixo.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/fuente.gif")));
		toolBar.add(tdKaixo);
		
		tbAgur = new JButton("Agur");
		tbAgur.addActionListener(this);
		tbAgur.setToolTipText("Agur");
		tbAgur.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/pegar.gif")));
		toolBar.add(tbAgur);
